  ...
  return (
    <div className="w-full p-0 m-0">
      <div className="w-full m-0">
        <h1 className="text-3xl font-bold mb-1">Add News</h1>
        <form onSubmit={handleSubmit} className="space-y-2 bg-white p-1 sm:p-2 md:p-3 rounded-lg shadow border border-gray-200 w-full max-w-full animate-fade-in">
