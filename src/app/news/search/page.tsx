...
export default function NewsSearch() {
  ...
  return (
    ...
    <div className="mx-auto p-16 bg-white rounded-xl shadow border border-gray-200 mt-8 w-full max-w-full mr-[10px]">
      {/* <form onSubmit={handleSearch} className="space-y-2 bg-white p-1 sm:p-2 md:p-3 rounded-lg shadow border border-gray-200 w-full max-w-full animate-fade-in"> */}
      <form onSubmit={handleSearch} className="flex gap-2 mb-4 p-1">
        <input
          type="text"
